...
<div class="container-fluid">
    <div class="row content">
        ...
        <div class="col-sm-10 right-side-content">
            <p><h4>Mokytojų sąrašas (mokytojų skaičius: )</h4></p>
            <div>
                <jsp:include page="../../resources/components/addTeacherModal.jsp"/>
            </div>
            <jsp:include page="../../resources/components/showTeachersList.jsp"/>
        </div>
        <jsp:include page="../../resources/components/changeSubjectModal.jsp"/>
    </div>
</div>
