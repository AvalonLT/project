...
<div class="container-fluid">
    <div class="row content">
        ...
        <div class="col-sm-10 right-side-content">
            <p><h4>Mokomųjų dalykų sąrašas (mokomųjų dalykų skaičius: )</h4></p>
            <div>
                <jsp:include page="../../resources/components/addSubjectModal.jsp"/>
            </div>
            <jsp:include page="../../resources/components/displaySubjectsList.jsp"/>
        </div>
    </div>
</div>
